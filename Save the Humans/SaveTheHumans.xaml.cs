...
{
    /// <summary>
    /// Interaction logic for SaveTheHumans.xaml
    /// </summary>
    public partial class SaveTheHumans : Window
    {
        ...
        private void EndTheGame()
        {
            if (!playArea.Children.Contains(gameOverText))
            {
                ...
                gameOverText.Text = "Game Over " + nameInput.Text + "!";
        ...
        private void StartGame()
        {
            ...
            scoreTally.Text = gameScore.ToString();
